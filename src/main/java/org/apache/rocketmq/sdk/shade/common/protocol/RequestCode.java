...
public class RequestCode {
    ...
    public static final int REQUEST_FOR_AUTHENTICATION = 400;
    public static final int REGISTER_TOPIC_USER = 401;
    public static final int UNREGISTER_TOPIC_USER = 402;
    public static final int UPDATE_TOPIC_USER = 403;
    public static final int DELETE_TOPIC = 404;
    public static final int DELETE_AKSK = 405;
    public static final int ADD_USER = 406;
    public static final int UPDATE_USER = 407;
    public static final int DELETE_USER = 408;
    public static final int REGISTER_TOPIC_PRODUCER = 409;
    public static final int REGISTER_TOPIC_CONSUMER = 410;
    public static final int UNREGISTER_TOPIC_PRODUCER = 411;
    public static final int UNREGISTER_TOPIC_CONSUMER = 412;
}
