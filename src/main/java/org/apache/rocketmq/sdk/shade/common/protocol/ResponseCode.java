...
import org.apache.rocketmq.sdk.shade.remoting.protocol.RemotingSysResponseCode;
...
public class ResponseCode extends RemotingSysResponseCode {
    ...
    public static final int AUTHENTICATE_FAILED = 209;
    public static final int REGISTER_FAILED = 210;
    public static final int UNREGISTER_FAILED = 211;
    public static final int TOPIC_OR_USER_NOT_EXIST = 212;
    public static final int USER_ALREADY_EXIST = 213;
    public static final int USER_NOT_EXIST = 214;
